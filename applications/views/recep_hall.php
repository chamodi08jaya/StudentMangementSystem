    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <ul>
            ...
            <li><a href="#" class="active"><i class="fa fa-users fa-fw"></i>Hall Management</a></li>
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">Hall number <span class="caret"></span></a></td>
